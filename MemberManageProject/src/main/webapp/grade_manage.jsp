...
function grade_search(search = ''){
	console.log(search);
	$.ajax({
		url : 'grade/search', //url기준으로 루트를 잡아야한다. delete만 하면 기존 함수가 실행된다.
		data : 'val='+search,
		type : 'post',
		dataType:'json',
		success: function(r){
		...
		<div class="manage_container">
			...
			<div class="content">
				<c:forEach var="item" items="${requestScope.list }">
					...
					<p>
						<input type='text' class='grade_no' value='${obj.key }' readonly>
						<input type='text' class='grade_name' value='${obj.value }'>
